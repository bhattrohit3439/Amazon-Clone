...
const Cart = ({ cartItems }) => {
	return (
		<div className='p-5 lg:flex m-auto max-w-[1500px] '>
			{/* left hand section */}
			<div>
				<img
					className='object-contain lg:w-4/5'
				...
				/>
				{cartItems.length === 0 ? (
					<div className='items-center justify-start p-10 my-8 bg-white md:flex lg:w-4/5 '>
						<img
							className='w-96'
					...
					<div className='p-5 my-8 bg-white lg:w-4/5 '>
				...
				<p className='text-xs font-semibold lg:w-4/5'>
